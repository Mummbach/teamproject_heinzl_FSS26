...
features (preprocessing/01d_extract_radiology_features.py output) if USE_CXR_FEATURES = 77.
...
Run AFTER: upstream preprocessing (X_*/y_*/timeseries.parquet exist),
           preprocessing/01d_extract_radiology_features.py (if USE_CXR_FEATURES).
"""
